...
LINUX_BIF_STUB(BIF_Cos)
LINUX_BIF_STUB(BIF_DllCall)
LINUX_BIF_STUB(BIF_Exp)
...
LINUX_BIF_STUB(BIF_Round)
LINUX_BIF_STUB(BIF_RunWait)
LINUX_BIF_STUB(BIF_Sin)
LINUX_BIF_STUB(BIF_Sort)
LINUX_BIF_STUB(BIF_Sound)
LINUX_BIF_STUB(BIF_SplitPath)
LINUX_BIF_STUB(BIF_SqrtLogLn)
LINUX_BIF_STUB(BIF_StrCase)
LINUX_BIF_STUB(BIF_StrCompare)
LINUX_BIF_STUB(BIF_StrGetPut)
LINUX_BIF_STUB(BIF_StrLen)
LINUX_BIF_STUB(BIF_StrPtr)
LINUX_BIF_STUB(BIF_StrReplace)
LINUX_BIF_STUB(BIF_SubStr)
LINUX_BIF_STUB(BIF_Tan)
LINUX_BIF_STUB(BIF_Trim)
LINUX_BIF_STUB(BIF_VerCompare)
