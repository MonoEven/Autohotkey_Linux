...
> `tests/doccheck/CHECK_REPORT.md`（1064/1064 断言，普通 + ASan 双构建）。
...
- **1064/1064** doc-check 断言通过（普通 + ASan 双构建，含 Xvfb 窗口/输入/控件/像素/定时器/热键/热字串/InputHook/图像/形状/GUI/菜单实测；输入模块含 Unicode 发送 3 项、round-36 增快速双击回归）
