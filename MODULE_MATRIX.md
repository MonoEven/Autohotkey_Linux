...
> `tests/doccheck/CHECK_REPORT.md`（1147/1147 断言，普通 + ASan 双构建）。
...
- **1147/1147** X11/headless doc-check 断言通过（普通 + ASan 双构建）
- **27/27** headless 回归测试；Wayland **17/17** + XWayland **254/254** 独立套件
