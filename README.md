...
| Developer tooling | VS Code 0.2.0: syntax/run/tasks/diagnostics/capabilities plus verified DBGp/DAP breakpoints, stack, paged Array/Map/Object variables and stepping |
