...
**Current release:** [`v2.0.26-linux.23`](https://github.com/MonoEven/Autohotkey_Linux/releases/latest)
...
# AppImage
chmod +x autohotkey-linux-2.0.26-linux.23-x86_64.AppImage
./autohotkey-linux-2.0.26-linux.23-x86_64.AppImage script.ahk
...
```bash
VER=2.0.26-linux.23 bash tools/linux/pack.sh
bash tools/linux/pack-rpm.sh 2.0.26-linux.23
bash tools/linux/pack-appimage.sh 2.0.26-linux.23
```
