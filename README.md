...
> coverage is broad (367 built-ins, 1129 doc-check assertions) and the
...
- **Latest build**: `v2.0.26-linux.15` (see
  ...
  Doc-check **1129/1129** (regular + ASan), regression 27/27,
...
- **Full X11 backend** (preferred when `DISPLAY` is set, including XWayland
  ...
  **1129/1129** assertions pass under Xvfb.
