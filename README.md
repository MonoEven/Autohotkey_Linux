...
**Current release:** [`v2.0.26-linux.18`](https://github.com/MonoEven/Autohotkey_Linux/releases/latest)
...
```bash
# Debian / Ubuntu
sudo apt install ./autohotkey-linux-2.0.26-linux.18-amd64.deb

# Fedora / openSUSE
sudo dnf install ./autohotkey-linux-2.0.26-linux.18-x86_64.rpm

# AppImage
chmod +x autohotkey-linux-2.0.26-linux.18-x86_64.AppImage
./autohotkey-linux-2.0.26-linux.18-x86_64.AppImage script.ahk
...
```bash
VER=2.0.26-linux.18 bash tools/linux/pack.sh
bash tools/linux/pack-rpm.sh 2.0.26-linux.18
bash tools/linux/pack-appimage.sh 2.0.26-linux.18
```
