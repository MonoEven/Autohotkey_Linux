...
| Input backends | Per-hotkey routing across X11, portal, GNOME Shell and evdev/uinput; versioned caps API; layout-aware xkbcommon key model and physical `scXXX` hotkeys on X11/evdev |
