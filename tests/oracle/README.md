...
stack/context/scalar properties, paged Array/Map/nested Object trees, detach
and the resumed script's external result. `run_dap_adapter_oracle.sh` drives the inline adapter as an external DAP
