...
echo "DAP_ADAPTER_ORACLE_PASS breakpoint=3 step=4 x=10 array_pages=2 array_count=20 alpha=A beta=42 map=101,202 dbus_proxy=1 typed_scalar=42 y=15 exception=6:D3-boom idle_pause_lt500ms=1 idle_value=77 detach=1 reconnect=2 ide_crash_cleanup=1 terminated=1"
