...
echo "DBGP_ORACLE_PASS breakpoint=3 step=4 array_pages=2 map=101,202 nested=42 dbus_proxy=1 typed_scalar=42 exception=6:D3-boom idle_pause_lt500ms=1 idle_stack=0 idle_value=77 stop=1"
