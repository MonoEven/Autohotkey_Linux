...
Check("Edit", Edit)
Check("EditGetCurrentCol", () => EditGetCurrentCol("x", "", "", ""))
Check("EditGetCurrentLine", () => EditGetCurrentLine("x", "", "", ""))
Check("EditGetLine", () => EditGetLine(1, "x", "", "", ""))
Check("EditGetLineCount", () => EditGetLineCount("x", "", "", ""))
Check("EditGetSelectedText", () => EditGetSelectedText("x", "", "", ""))
Check("EditPaste", () => EditPaste("x", "y", "", "", ""))
...
Check("ListViewGetContent", ListViewGetContent)
