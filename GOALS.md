...
- VSC-2 D3 remaining: Array/Map/Object paging is delivered across raw DBGp,
  external DAP and real VS Code; exception breaks, idle pause/reconnect and a
  real D-Bus object projection remain.
