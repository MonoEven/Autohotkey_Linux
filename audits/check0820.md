> **历史审计快照（2026-08-20）。** 本文保留 linux.13/15 阶段的事实；
> 当前状态请看 `../README.md`、`check_detail0821.md` 文首实质完成审计表和最新 Release。
...
| 发布 v2.0.26-linux.15 | 已发布（linux.15 前 release 已删，仅 .15 保留 7 资产；linux.14/.13 的 git tag 保留源码回滚） | CI run 32405280166 全绿后上传 | 见发布节 |